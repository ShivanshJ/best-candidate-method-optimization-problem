...
/*
int c[20][20],sup[20],dem[20]; //Incase of input
*/
 int m,n; //Input of number of rows and columns
 int M,N;
...
//To get the final path matrix of the best sum
func(0,best_pos,0);
...
{ int i,j,b,p,d,k;
  ...
  system("cls");
  printf(".............Transportation problem Using Best Candidates Method........\n");
  printf("\nEnter the number of rows & columns respectively:\n");
  scanf("%d%d",&m,&n);
...
//If you want to take an input, remove comment line below
 /* 
 int c[20][20],dem[20],sup[20];
 ...
 printf("\nEnter the cost:");
  ...
  printf("\n\nThe final approximated cost using BCM is : %d \n\n",sum);
